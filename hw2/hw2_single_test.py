# single test
# type "python hw2_single_test.py {X_test} {hw2_best.csv}" to execute
...
def main(script, X_test, output):
	# load model
	# model = load_model('./hw2_single_model/model.h5')
	model = joblib.load('./hw2_single_model/model.pkl')

	# load testing data
	x_test = load_data(X_test)

	# feature scaling
	x_mean = np.load('./hw2_single_model/x_mean.npy')
	x_std = np.load('./hw2_single_model/x_std.npy')
